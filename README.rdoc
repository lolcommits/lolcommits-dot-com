...
Hosts a gallery of your lolcommits at [lolcommits.com](https://lolcommits.com)
...
Visit [GitHub Applications](https://github.com/settings/applications) and create
a new app, making sure to set the following:
